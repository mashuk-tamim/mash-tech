    ...
    <div className="flex flex-col md:flex-row font-medium md:text-white text-xs md:text-sm lg:text-base">
        ...
        <li>
            <NavLink to="/addProduct">
                <BsDatabaseFillAdd className="hidden lg:flex"></BsDatabaseFillAdd>
                Add Product
            </NavLink>
        </li>
        <li>
            <NavLink to="/carts">
                <BsFillCartPlusFill className="hidden lg:flex"></BsFillCartPlusFill>
                My Cart
            </NavLink>
        </li>
        <li>
            <NavLink to="/blog">
                <FaBlogger className="hidden lg:flex"></FaBlogger>Blog
            </NavLink>
        </li>
        {/* <li>
...
const Navbar = () => {
    ...
    return (
        <div
            ...
            } text-white font-montserrat lg:py-3`}
        >
            <div className="navbar-start flex justify-start">
                ...
                <div>
                    <label className="swap swap-rotate px-2">
                        ...
                        {/* sun icon */}
                        <svg
                            className="swap-on fill-current w-[25px] md:w-[30px] h-full my-auto pt-1"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                        >
                        ...
                        {/* moon icon */}
                        <svg
                            className="swap-off fill-current w-[20px] md:w-[30px] h-full my-auto pt-1"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                        >
                ...
                <Link to="/">
                    <div className="flex items-center">
                        <img
                            className="w-[20px] md:w-1/5 lg:w-[30px]"
                            src={logo_white}
                            alt=""
                        />
            ...
            <div className="navbar-end">
                {user && (
                    <div className="flex flex-row md:flex-col lg:flex-row gap-1 items-center  rounded-l-full rounded-r-full p-0 w-1/2 mr-2">
